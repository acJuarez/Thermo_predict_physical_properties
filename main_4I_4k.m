...
thermostatFlag = 1; % set to 1 to turn it on
nu = 1;          % frequency of collisions with heatbath
velSTD = Temp^0.5;  % the standard deviation for velocities drawn from the Boltzmann distribution at some temperature
...
%% 4.k
figure
histogram( totalE(1001:end) );
title('Total energy histogram');
xlabel('Total energy');
varU = var( totalE(1001:end) );
